            ...
            <div class="card-body p-0">
                <div class="p-5">
                    <div class="text-center">
                        <h1 class="h4  mb-4"  style="color: #d4a762;"><strong>Tambah Data Produk</strong></h1>
                    </div>
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary" id="tambahkanBtn3" style="background-color: #d4a762; border-color: #d4a762; color: white;">Ya, Tambahkan</button>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
