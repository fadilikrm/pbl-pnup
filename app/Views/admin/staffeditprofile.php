        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                <div class="p-5">
                    ...
                    <form class="user" action="<?= route_to('staffeditprofilestore') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                              ...
                                              <button type="submit" class="btn btn-primary" id="tombolEdit" style="background-color: #d4a762; border-color: #d4a762;">Ya, Edit</button>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
