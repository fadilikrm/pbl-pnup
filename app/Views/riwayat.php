...
<?= $this->section('auth') ?><br>
<!-- Begin Page Content -->
<div class="container-fluid">
    <a href="<?php echo base_url("/index.php") ?>" class="btn btn-secondary" style="margin-right: 10px;">
    ...
    <p class="mb-4">Tabel ini digunakan untuk melihat riwayat transaksi yang anda miliki, jadi untuk melakukan transaksi, anda bisa melakukan tangkapan layar(screenshot) pada struk yang tersedia di menu ini, dan kemudian masuk ke WA UMKM ini untuk memberikan struk dan melakukan transaksi disana, nanti setelah dibayar maka status transaksi nya akan diubah oleh UMKM ini untuk proses selanjutnya</p>
    ...
    <p>
        ...
        <span style="vertical-align: middle;">Digunakan untuk melihat data</span>
    </p>
    <p>
        <a class="btn btn-warning" style="margin-right: 10px;">
            <i class="fas fa-pencil-alt"></i>
        </a>
        <span style="vertical-align: middle;">Digunakan untuk mengubah data</span>
    </p>
    <p>
        <a class="btn btn-danger" style="margin-right: 10px;">
            <i class="fas fa-trash-alt"></i>
        </a>
        <span style="vertical-align: middle;">Digunakan untuk menghapus data</span>
    </p>
    <!-- DataTales Example -->
            ...
            <div class="text-weight mb-3">
                <div class="card-body">
                    <div class="table-responsive">
                        <a href="https://wa.me/628991587184?text=Saya%20ingin%20melakukan%20pembayaran" class="btn btn-success"><i class="fab fa-whatsapp"></i></a>
                        <br>
                        <br>
                                ...
                                <?php foreach ($transaksi as $t) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('riwayatedit/' . $t['id_transaksi']); ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?= site_url('riwayatdestroy/' . $t['id_transaksi']); ?>" class="btn btn-danger">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
