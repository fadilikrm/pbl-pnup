...
use App\Controllers\TransaksiPelanggan;
...
$routes->get('/checkout', [CheckoutController::class, 'checkout'], ['as' => 'checkout']);
$routes->post('/transaksitambahstore', [TransaksiPelanggan::class, 'transaksitambahstore'], ['as' => 'transaksitambahstore']);
$routes->get('/riwayat', [TransaksiPelanggan::class, 'riwayat'], ['as' => 'riwayat']);
$routes->get('/riwayatedit/(:num)', [TransaksiPelanggan::class, 'riwayatedit/$1'], ['as' => 'riwayatedit']);
$routes->post('/riwayateditstore', [TransaksiPelanggan::class, 'riwayateditstore'], ['as' => 'riwayateditstore']);
$routes->get('/riwayatdestroy/(:num)', [TransaksiPelanggan::class, 'riwayatdestroy/$1'], ['as' => 'riwayatdestroy']);
...
$routes->get('/admin/dashboardomsetharian', [Dashboard::class, 'dashboardomsetharian'], ['as' => 'dashboardomsetharian']);
$routes->get('/admin/dashboardomsetbulanan', [Dashboard::class, 'dashboardomsetbulanan'], ['as' => 'dashboardomsetbulanan']);
$routes->get('/admin/dashboardomsettahunan', [Dashboard::class, 'dashboardomsettahunan'], ['as' => 'dashboardomsettahunan']);
$routes->get('/admin/dashboardprodukharian', [Dashboard::class, 'dashboardprodukharian'], ['as' => 'dashboardprodukharian']);
$routes->get('/admin/dashboardprodukbulanan', [Dashboard::class, 'dashboardprodukbulanan'], ['as' => 'dashboardprodukbulanan']);
$routes->get('/admin/dashboardproduktahunan', [Dashboard::class, 'dashboardproduktahunan'], ['as' => 'dashboardproduktahunan']);
...
$routes->get('/admin/staffeditprofile/(:num)', [StaffController::class, 'staffeditprofile/$1'], ['as' => 'staffeditprofile']);
$routes->post('/admin/staffeditprofilestore', [StaffController::class, 'staffeditprofilestore'], ['as' => 'staffeditprofilestore']);
...
$routes->get('/admin/transaksi', [TransaksiController::class, 'transaksi'], ['as' => 'transaksi']);
$routes->post('/admin/transaksitambahstore', [TransaksiController::class, 'transaksitambahstore'], ['as' => 'transaksitambahstore']);
$routes->get('/admin/transaksiedit/(:num)', [TransaksiController::class, 'transaksiedit/$1'], ['as' => 'transaksiedit']);
$routes->post('/admin/transaksieditstore', [TransaksiController::class, 'transaksieditstore'], ['as' => 'transaksieditstore']);
$routes->get('/admin/transaksidestroy/(:num)', [TransaksiController::class, 'transaksidestroy/$1'], ['as' => 'transaksidestroy']);
